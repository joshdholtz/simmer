class Simmer < Formula
  ...
  on_arm do
    url "https://github.com/joshdholtz/simmer/releases/download/v0.1.0/simmer-v0.1.0-arm64.tar.gz"
    sha256 "" # filled in by release workflow
  end

  on_intel do
    url "https://github.com/joshdholtz/simmer/releases/download/v0.1.0/simmer-v0.1.0-x86_64.tar.gz"
    sha256 "" # filled in by release workflow
  end
